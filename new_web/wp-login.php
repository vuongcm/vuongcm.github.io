...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	<title>Đăng nhập &#8211; Kiwi&#039;s mom</title>
	<?php
	...
	?>
	<link rel="stylesheet" id="storefront-icons-css" href="https://kiwismom.com/wp-content/themes/child-storefront/assets/css/base/icons.css" media="all">
	<link rel="stylesheet" id="63-css" href="https://kiwismom.com/wp-content/themes/child-storefront/assets/css/base/main.css" media="all">
	</head>
	...
	<div id="loading">
        <div id="loading-center">
            <div id="loading-center-absolute">
                ...
                <div class="object-load" id="object_four"></div>
                <div class="object-load" id="object_five"></div>
            </div>
        </div>
    </div>
	<?php
	...
	?>
	<div id="login">
		<h1><a href="https://kiwismom.com">Kiwi's mom</a></h1>
	<?php
	/**
	...
	default:
		...
		if ( ! $interim_login ) {
			...
			<p id="nav">
				...
				if ( get_option( 'users_can_register' ) ) {
					/*$registration_url = sprintf( '<a href="%s">%s</a>', esc_url( wp_registration_url() ), __( 'Register' ) );*/
					$registration_url = sprintf( '<a href="%s">%s</a>', esc_url( '/dang-ky' ), __( 'Register' ) );
					/** This filter is documented in wp-includes/general-template.php */
					echo apply_filters( 'register', $registration_url );
